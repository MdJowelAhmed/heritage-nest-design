    ...
    return (
        <div className="max-w-[1216px] mx-auto">
            <div className="w-[820px] ml-20">
                ...
                <div className="flex gap-2 mb-16 pl-6">
                    <p className="bg-[#0059B1] text-white border-2 px-1 text-xl w-8">01</p>
                    <p className="bg-[#ECF5FF] border-2 px-1 text-xl w-8">02</p>
                    <p className="bg-[#ECF5FF] border-2 px-2 text-xl w-16">Next</p>
                </div>
            </div>
